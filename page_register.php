                            ...
                            <div class="col-xl-6 ml-auto mr-auto">
                                <div class="card p-4 rounded-plus bg-faded">
                                    ...
                                    <?php
                                        ...
                                        if (!empty($_SESSION['danger'])) display_flash_message('danger');
                                        elseif (!empty($_SESSION['success'])) display_flash_message('success');
                                    ...
                                    <form id="js-login" action="register.php" method="post">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="password" id="userpassword" class="form-control" placeholder="password" name="password" required>
                                            <div class="invalid-feedback">Заполните поле.</div>
                                        </div>
